	...
	return (
		<div className="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden animate-in fade-in slide-in-from-bottom-4 duration-500">
			<div className="px-6 py-5 border-b bg-slate-50/50 flex items-center gap-3">
				...
				<h2 className="text-2xl font-semibold text-slate-900">Guest Checkout</h2>
			</div>
			...
			<div className="p-6 md:p-8">
				...
				<div className="mt-10 flex flex-wrap gap-4">
								<button
						className="flex-1 min-w-35 bg-[#1E293B] text-white py-4 rounded-xl font-bold hover:bg-slate-800 shadow-lg uppercase tracking-widest text-xs disabled:opacity-60 disabled:cursor-not-allowed flex items-center justify-center gap-2"
					...
					>
						...
						{isPaid ? 'Paid' : 'Pay Now'}
								...
								<button
						className="flex-1 min-w-35 bg-white border border-slate-200 text-slate-500 py-4 rounded-xl font-bold hover:bg-slate-50 uppercase tracking-widest text-xs flex items-center justify-center gap-2"
						onClick={handlePrint}
					>
						<Printer size={16} />
						Print Invoice
					</button>
					<button className="flex-1 min-w-35 bg-white border border-slate-200 text-slate-500 py-4 rounded-xl font-bold hover:bg-slate-50 uppercase tracking-widest text-xs flex items-center justify-center gap-2">
						<X size={16} />
						Cancel
					</button>
				</div>
